...
# Save script path
script_path = "/path/to/protocol-summary/scripts/generate_pdf.py"

# Import and call directly
import sys
sys.path.insert(0, "/path/to/protocol-summary/scripts")
...
========================
Generated by: Claude (protocol-summary skill)
