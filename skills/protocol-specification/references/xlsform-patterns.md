...
form_id:     [CDASH code or custom — no spaces, start with letter]
...
| bind::oc:itemgroup | CDASH domain group (e.g., AE, VS, LB) | OpenClinica-specific |
...
- `bind::oc:itemgroup` must match the form_id's CDASH domain code for
  data to map correctly in the study database
